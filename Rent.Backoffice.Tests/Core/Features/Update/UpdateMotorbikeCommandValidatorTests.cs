...
public class UpdateMotorbikeCommandValidatorTests
{
    private readonly UpdateMotorbikeCommandValidator _validator = new();
    private readonly UpdateMotorbikeCommand _motorbikeSample = new(Guid.NewGuid(), 2024, "Honda Titan 160", "FMK0B49");
    ...
    {
        var motorbike = _motorbikeSample with { Id = Guid.Empty };
